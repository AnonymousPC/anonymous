    ...
    extends public std::streambuf
{
    private: // Precondition
        static_assert ( same_as<protocol,tcp> or same_as<protocol,ssl> ); // http/https.
    ...
    private: // Data
        ...
        /* Thus, pack everything within boost::beast in a std::unique_ptr */
        enum { none, client, server };

        typename protocol::socket                                                                 handle                       = nullptr;
        ...
        float                                                                                     current_request_version      = 0.0;
        map<string,string>                                                                        current_request_header       = {};
        float                                                                                     current_response_version     = 0.0;
